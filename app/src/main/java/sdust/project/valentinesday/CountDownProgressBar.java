...
public class CountDownProgressBar extends View {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.CountDownProgressBar_countDown_secondColor:
                    secondColor = ta.getColor(attr, Color.WHITE); // 默认进度条颜色为蓝色
                    break;
                case R.styleable.CountDownProgressBar_countDown_centerTextSize:
                    centerTextSize = ta.getDimensionPixelSize(attr, (int) dip2px(10)); // 默认中间文字字体大小为40dp
                    break;
                case R.styleable.CountDownProgressBar_countDown_circleWidth:
                    circleWidth = ta.getDimensionPixelSize(attr, (int) dip2px(3f)); // 默认圆弧宽度为6dp
                    break;
                case R.styleable.CountDownProgressBar_countDown_centerTextColor:
                    centerTextColor = ta.getColor(attr, Color.WHITE); // 默认中间文字颜色为蓝色
                    break;
    ...
    private void drawCircle(Canvas canvas, int center, int radius) {
        ...
        //  circlePaint.setShadowLayer(10, 10, 10, Color.WHITE);
